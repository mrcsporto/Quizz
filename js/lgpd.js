...
1.1. Para participação no concurso, o(a) associado(a) deverá ter ciência e dar o devido aceite ao presente regulamento.

1.2. Caso o(a) associado(a) cometa alguma fraude ou viole alguma regra, procedimento ou o sistemas estabelecidos para participação no concurso,  o(a) respectivo(a) será sumariamente excluído(a) do concurso e, consequentemente, significará na revogação dos prêmios oferecidos.

1.3. O concurso possui um caráter exclusivamente cultural, sem qualquer modalidade de sorteio ou pagamento. 

2.  Da Vigência e Local do Concurso
...
3.3. Para aqueles cirurgiões-dentistas congressistas que não são associados da APCD/ABCD, seja por qualquer motivo, só poderão participar do concurso caso se torne associado(a) e pague uma semestralidade da taxa associativa.
...
4.3. Caso o(a) participante participe mais de uma vez ao dia, suas respostas serão desconsideradas e o(a) participante será desclassificado do concurso daquele dia.

5. Da dinâmica do concurso

5.1. O(a) participante irá responder 03 (três) perguntas, selecionadas de forma aleatória pelo programa.

5.2. O(a) participante terá 15 (quinze) segundos para responder cada pergunta.

5.3. Caso o(a) participante não responda a pergunta no tempo indicado no item 5.2, a resposta será considerada incorreta.
...
6.3. Será considerado vencedor(a) do dia aquele(a) que obter a maior pontuação em menos tempo. Caso o(a) vencedor(a) possua débitos com a APCD/ABCD, o(a) mesmo(a) será desclassificado(a) e será considerado(a) vencedor(a) aquele que obter a segunda maior pontuação em menos tempo, e assim sucessivamente.

6.4. Caso haja empate entre os participantes, será considerado(a) vencedor(a) aquele que participou primeiro do concurso. 
...
7.1 Os vencedores do concurso serão comunicados através do e-mail, telefone e celular informados no momento da sua participação no concurso. É de responsabilidade do(a) associado(a) informar corretamente à APCD os dados de contato no momento da participação do concurso.

7.2. As entregas dos equipos serão de responsabilidade das empresas patrocinadoras, sendo que a respectivas realizarão contato prévio para que seja devidamente agendada a entrega.

7.3. Caso não tenha um(a) responsável para recepcionar o prêmio no momento da entrega no endereço indicado pelo(a) vencedor(a), o(a) vencedor(a) terá o prazo de 10 (dez) dias, a contar da tentativa de entrega infrutífera, para retirar o equipo no local indicado pela patrocinadora.

7.4. Os prêmios deste concurso não são transferíveis. Os vencedores não poderão exigir a troca de seus prêmios pelo seu valor em dinheiro ou em outro produto.
...
9.1. A APCD se reserva o direito de modificar as regras do presente concurso de forma total ou parcial, onde comunicará de forma prévia tal medida, sendo que divulgará a mudança nos moldes da divulgação deste regulamento.

9.2. Caso ocorra algum imprevisto que justifique tal ato, a APCD poderá divulgar os vencedores após as datas previstas no presente regulamento.

9.3. A participação do(a) associado(a) neste concurso implica na aceitação total e irrevogável das regras constantes no corpo do presente regulamento, assim como as decisões posteriormente adotadas pela APCD em razão das mesmas ou por qualquer outra questão advinda não prevista.

9.4. A APCD não será responsabilizada por nenhuma interrupção, corte ou falha que possa justificar a não participação do associado, incluindo neste sentido, falha no programa utilizado pela empresa contratada.
